...
export class StepperSampleReactiveFormsComponent {
    ...
    public cards: any[] = [
        {
            img: 'https://staging.infragistics.com/angular-demos/assets/images/stepper/card-gold.png',
            price: 400,
        ...
        {
            img: 'https://staging.infragistics.com/angular-demos/assets/images/stepper/card-red.png',
            price: 600,
            offer: 'STATEMENT CREDIT OFFER',
        ...
        {
            img: 'https://staging.infragistics.com/angular-demos/assets/images/stepper/card-blue.png',
            price: 500,
            offer: 'STATEMENT CREDIT OFFER',
