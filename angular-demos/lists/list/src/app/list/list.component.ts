...
@Component({
    ...
    imports: [IgxInputGroupComponent, IgxPrefixDirective, IgxIconComponent, FormsModule, IgxInputDirective, IgxSuffixDirective, IgxListComponent, IgxListItemComponent, IgxRippleDirective, IgxAvatarComponent, IgxListThumbnailDirective, IgxListLineTitleDirective, IgxListLineSubTitleDirective, IgxListActionDirective, IgxFilterPipe]
})
export class ListComponent {
    ...
    public contacts = [{
        avatar: 'https://staging.infragistics.com/angular-demos/assets/images/avatar/1.jpg',
        favorite: true,
        key: '1',
        link: '#',
        name: 'Terrance Orta',
        ...
        avatar: 'https://staging.infragistics.com/angular-demos/assets/images/avatar/3.jpg',
        favorite: false,
        key: '3',
        link: '#',
        name: 'Donna Price',
        ...
        avatar: 'https://staging.infragistics.com/angular-demos/assets/images/avatar/12.jpg',
        favorite: true,
        key: '5',
        link: '#',
        ...
        avatar: 'https://staging.infragistics.com/angular-demos/assets/images/avatar/13.jpg',
        favorite: false,
        key: '6',
        link: '#',
        name: 'Stephanie May',
        ...
        avatar: 'https://staging.infragistics.com/angular-demos/assets/images/avatar/15.jpg',
        favorite: true,
        key: '8',
        link: '#',
        name: 'Tammie Alvarez',
        ...
        avatar: 'https://staging.infragistics.com/angular-demos/assets/images/avatar/16.jpg',
        favorite: true,
        key: '9',
        link: '#',
