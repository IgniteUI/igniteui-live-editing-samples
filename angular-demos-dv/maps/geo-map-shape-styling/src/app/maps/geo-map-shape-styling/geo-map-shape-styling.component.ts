...
@Component({
  selector: "app-geo-map-shape-styling",
  styleUrls: ["./geo-map-shape-styling.component.scss"],
  templateUrl: "./geo-map-shape-styling.component.html"
})
export class MapShapeStylingComponent implements AfterViewInit {
