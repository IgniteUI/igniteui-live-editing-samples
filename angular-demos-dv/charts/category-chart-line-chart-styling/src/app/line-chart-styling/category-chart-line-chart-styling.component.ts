...
@Component({
    selector: 'app-category-chart-line-chart-styling',
    templateUrl: './category-chart-line-chart-styling.component.html',
    styleUrls: ['./category-chart-line-chart-styling.component.scss']
})
export class CategoryChartLineChartStylingComponent implements OnInit {
