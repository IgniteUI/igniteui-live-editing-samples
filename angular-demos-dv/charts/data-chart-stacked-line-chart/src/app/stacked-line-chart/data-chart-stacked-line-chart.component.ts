...
@Component({
  selector: "app-data-chart-stacked-line-chart",
  templateUrl: "./data-chart-stacked-line-chart.component.html",
  styleUrls: ["./data-chart-stacked-line-chart.component.scss"]
})
export class DataChartStackedLineChartComponent {
