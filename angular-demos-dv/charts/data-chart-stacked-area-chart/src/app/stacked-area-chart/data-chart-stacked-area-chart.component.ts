...
@Component({
  selector: "app-data-chart-stacked-area-chart",
  templateUrl: "./data-chart-stacked-area-chart.component.html",
  styleUrls: ["./data-chart-stacked-area-chart.component.scss"]
})
export class DataChartStackedAreaChartComponent {
