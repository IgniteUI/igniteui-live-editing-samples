...
@Component({
    selector: 'app-data-chart-scatter-bubble-chart-single-source',
    templateUrl: './data-chart-scatter-bubble-chart-single-source.component.html',
    styleUrls: ['./data-chart-scatter-bubble-chart-single-source.component.scss']
})
export class DataChartScatterBubbleChartSingleSourceComponent implements OnInit {
