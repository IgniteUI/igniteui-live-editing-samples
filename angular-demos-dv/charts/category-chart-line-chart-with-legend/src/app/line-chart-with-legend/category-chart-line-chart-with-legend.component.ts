...
@Component({
    selector: 'app-category-chart-line-chart-with-legend',
    templateUrl: './category-chart-line-chart-with-legend.component.html',
    styleUrls: ['./category-chart-line-chart-with-legend.component.scss']
})
export class CategoryChartLineChartWithLegendComponent implements OnInit {
