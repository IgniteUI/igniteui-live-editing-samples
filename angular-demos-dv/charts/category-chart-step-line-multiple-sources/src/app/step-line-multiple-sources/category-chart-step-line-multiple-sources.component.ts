...
@Component({
    ...
    selector: "app-category-chart-step-line-multiple-sources",
    styleUrls: ["./category-chart-step-line-multiple-sources.component.scss"],
    templateUrl: "./category-chart-step-line-multiple-sources.component.html"
})
export class CategoryChartStepLineMultipleSourcesComponent {
