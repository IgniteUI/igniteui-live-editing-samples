...
@Component({
    ...
    selector: "app-category-chart-spline-area-styling",
    styleUrls: ["./category-chart-spline-area-styling.component.scss"],
    templateUrl: "./category-chart-spline-area-styling.component.html"
})
export class CategoryChartSplineAreaStylingComponent {
    public data: any;
