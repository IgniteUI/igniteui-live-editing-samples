...
@Component({
  selector: 'app-category-chart-area-chart-styling',
  templateUrl: './category-chart-area-chart-styling.component.html',
  styleUrls: ['./category-chart-area-chart-styling.component.scss']
})
export class CategoryChartAreaChartStylingComponent implements OnInit {
