...
@Component({
    selector: 'app-category-chart-area-chart-multiple-sources',
    templateUrl: './category-chart-area-chart-multiple-sources.component.html',
    styleUrls: ['./category-chart-area-chart-multiple-sources.component.scss']
})
export class CategoryChartAreaChartMultipleSourcesComponent implements OnInit {
