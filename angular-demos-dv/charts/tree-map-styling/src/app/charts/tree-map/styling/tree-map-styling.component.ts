...
import { IgxTreemapComponent, IgxTreemapNodeStyleMappingComponent, TreemapValueMappingMode } from "igniteui-angular-charts";

@Component({
    selector: 'app-tree-map-styling',
    templateUrl: './tree-map-styling.component.html',
    styleUrls: ['./tree-map-styling.component.scss']
})
export class TreeMapStylingComponent implements AfterViewInit {
    ...
    addStyleMapping(valueID: string, fillColor: string) {

        const mapping : IgxTreemapNodeStyleMappingComponent = new IgxTreemapNodeStyleMappingComponent();
        mapping.value = valueID;
        mapping.fill = fillColor;
        mapping.mappingMode = TreemapValueMappingMode.CustomValue;
        this.treemap.styleMappings.add(mapping);
    }
