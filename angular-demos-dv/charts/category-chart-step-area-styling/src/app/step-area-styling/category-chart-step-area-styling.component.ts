...
@Component({
    ...
    selector: "app-category-chart-step-area-styling",
    styleUrls: ["./category-chart-step-area-styling.component.scss"],
    templateUrl: "./category-chart-step-area-styling.component.html"
})
export class CategoryChartStepAreaStylingComponent {
