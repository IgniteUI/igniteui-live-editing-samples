...
@Component({
  selector: "app-data-chart-bar-chart-with-legend",
  templateUrl: "./data-chart-bar-chart-with-legend.component.html",
  styleUrls: ["./data-chart-bar-chart-with-legend.component.scss"]
})
export class DataChartBarChartWithLegendComponent {
