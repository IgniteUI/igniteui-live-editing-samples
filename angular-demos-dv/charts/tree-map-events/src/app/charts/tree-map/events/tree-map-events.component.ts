...
@Component({
    selector: 'app-tree-map-events',
    templateUrl: './tree-map-events.component.html',
    styleUrls: ['./tree-map-events.component.scss']
})
export class TreeMapEventsComponent implements OnInit {

    public data: any[];

    public SelectedNodeName : string;
    public SelectedNodeParent : string;
    public SelectedNodeValue : string;

    public HoveredNodeName : string;
