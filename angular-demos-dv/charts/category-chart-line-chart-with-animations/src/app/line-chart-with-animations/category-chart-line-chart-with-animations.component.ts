...
@Component({
    ...
    selector: "app-category-chart-line-chart-with-animations",
    styleUrls: ["./category-chart-line-chart-with-animations.component.scss"],
    templateUrl: "./category-chart-line-chart-with-animations.component.html"
})
export class CategoryChartLineChartWithAnimationsComponent {
