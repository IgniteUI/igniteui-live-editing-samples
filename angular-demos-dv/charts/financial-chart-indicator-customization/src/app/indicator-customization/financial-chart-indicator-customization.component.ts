...
@Component({
    ...
    selector: "app-financial-chart-indicator-customization",
    styleUrls: ["./financial-chart-indicator-customization.component.scss"],
    templateUrl: "./financial-chart-indicator-customization.component.html"
})
export class FinancialChartIndicatorCustomizationComponent {
    public data: any;
