...
@Component({
  selector: "app-data-chart-stacked-spline-area-chart",
  templateUrl: "./data-chart-stacked-spline-area-chart.component.html",
  styleUrls: ["./data-chart-stacked-spline-area-chart.component.scss"]
})
export class DataChartStackedSplineAreaChartComponent {
