...
@Component({
    selector: 'app-category-chart-column-chart-multiple-sources',
    templateUrl: './category-chart-column-chart-multiple-sources.component.html',
    styleUrls: ['./category-chart-column-chart-multiple-sources.component.scss']
})
export class CategoryChartColumnChartMultipleSourcesComponent {
