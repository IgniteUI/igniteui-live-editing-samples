...
@Component({
  selector: "app-data-chart-stacked-100-line-chart",
  templateUrl: "./data-chart-stacked-100-line-chart.component.html",
  styleUrls: ["./data-chart-stacked-100-line-chart.component.scss"]
})
export class DataChartStacked100LineChartComponent {
