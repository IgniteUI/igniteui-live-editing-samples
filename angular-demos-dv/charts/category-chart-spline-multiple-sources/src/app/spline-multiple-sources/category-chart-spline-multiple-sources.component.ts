...
@Component({
    ...
    selector: "app-category-chart-spline-multiple-sources",
    styleUrls: ["./category-chart-spline-multiple-sources.component.scss"],
    templateUrl: "./category-chart-spline-multiple-sources.component.html"
})
export class CategoryChartSplineMultipleSourcesComponent {
