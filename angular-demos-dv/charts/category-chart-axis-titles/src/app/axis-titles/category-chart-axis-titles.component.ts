...
@Component({
    ...
    selector: "app-category-chart-axis-titles",
    styleUrls: ["./category-chart-axis-titles.component.scss"],
    templateUrl: "./category-chart-axis-titles.component.html"
})
export class CategoryChartAxisTitlesComponent {
