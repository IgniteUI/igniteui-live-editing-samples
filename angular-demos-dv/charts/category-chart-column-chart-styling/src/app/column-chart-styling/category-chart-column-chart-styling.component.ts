...
@Component({
    selector: 'app-category-chart-column-chart-styling',
    templateUrl: './category-chart-column-chart-styling.component.html',
    styleUrls: ['./category-chart-column-chart-styling.component.scss']
})
export class CategoryChartColumnChartStylingComponent implements OnInit {
