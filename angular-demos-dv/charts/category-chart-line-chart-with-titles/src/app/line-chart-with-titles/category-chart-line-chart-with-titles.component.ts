...
@Component({
    selector: 'app-category-chart-line-chart-with-titles',
    templateUrl: './category-chart-line-chart-with-titles.component.html',
    styleUrls: ['./category-chart-line-chart-with-titles.component.scss']
})
export class CategoryChartLineChartWithTitlesComponent implements OnInit {
