...
@Component({
  selector: 'app-data-chart-type-financial-column-indicators',
  templateUrl: './data-chart-type-financial-column-indicators.component.html',
  styleUrls: ['./data-chart-type-financial-column-indicators.component.scss']
})
export class DataChartTypeFinancialColumnIndicatorsComponent implements OnInit {
