...
@Component({
    ...
    selector: "app-category-chart-stack-columns",
    styleUrls: ["./category-chart-stack-columns.component.scss"],
    templateUrl: "./category-chart-stack-columns.component.html"
})

export class CategoryChartStackColumnsComponent implements AfterViewInit {
