...
@Component({
  selector: "app-data-chart-type-stacked-spline-area-series",
  templateUrl: "./data-chart-type-stacked-spline-area-series.component.html",
  styleUrls: ["./data-chart-type-stacked-spline-area-series.component.scss"]
})
export class DataChartTypeStackedSplineAreaSeriesComponent {
