...
@Component({
    selector: 'app-category-chart-line-chart-multiple-sources',
    templateUrl: './category-chart-line-chart-multiple-sources.component.html',
    styleUrls: ['./category-chart-line-chart-multiple-sources.component.scss']
})
export class CategoryChartLineChartMultipleSourcesComponent implements OnInit {
