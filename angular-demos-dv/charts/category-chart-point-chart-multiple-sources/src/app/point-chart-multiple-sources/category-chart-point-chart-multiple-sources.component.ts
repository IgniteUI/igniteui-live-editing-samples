...
@Component({
    selector: 'app-category-chart-point-chart-multiple-sources',
    templateUrl: './category-chart-point-chart-multiple-sources.component.html',
    styleUrls: ['./category-chart-point-chart-multiple-sources.component.scss']
})
export class CategoryChartPointChartMultipleSourcesComponent implements OnInit {
