...
@Component({
  selector: "app-data-chart-stacked-spline-chart",
  templateUrl: "./data-chart-stacked-spline-chart.component.html",
  styleUrls: ["./data-chart-stacked-spline-chart.component.scss"]
})
export class DataChartStackedSplineChartComponent {
