...
@Component({
  selector: "app-data-chart-stacked-100-spline-chart",
  templateUrl: "./data-chart-stacked-100-spline-chart.component.html",
  styleUrls: ["./data-chart-stacked-100-spline-chart.component.scss"]
})
export class DataChartStacked100SplineChartComponent {
