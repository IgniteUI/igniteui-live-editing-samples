...
@Component({
    selector: 'app-category-chart-axis-tickmarks',
    templateUrl: './category-chart-axis-tickmarks.component.html',
    styleUrls: ['./category-chart-axis-tickmarks.component.scss']
})
export class CategoryChartAxisTickmarksComponent implements OnInit {

    public data : any[];

    public AxisTickLength : number = 10;

    constructor() { }

    public OnAxisTickLengthChange(e: any) {
        this.AxisTickLength = Number.parseInt(e.target.value);
    }
