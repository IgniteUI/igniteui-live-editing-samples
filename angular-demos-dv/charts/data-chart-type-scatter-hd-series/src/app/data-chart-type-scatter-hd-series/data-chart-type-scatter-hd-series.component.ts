...
@Component({
    selector: "app-data-chart-type-scatter-hd-series",
    styleUrls: ["./data-chart-type-scatter-hd-series.component.scss"],
    templateUrl: "./data-chart-type-scatter-hd-series.component.html"
})
export class DataChartTypeScatterHdSeriesComponent implements OnInit {
