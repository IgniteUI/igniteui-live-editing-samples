...
@Component({
    ...
    selector: "app-category-chart-spline-styling",
    styleUrls: ["./category-chart-spline-styling.component.scss"],
    templateUrl: "./category-chart-spline-styling.component.html"
})
export class CategoryChartSplineStylingComponent {
