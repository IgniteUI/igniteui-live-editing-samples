...
@Component({
  selector: "app-data-chart-type-stacked100-spline-area-series",
  templateUrl: "./data-chart-type-stacked100-spline-area-series.component.html",
  styleUrls: ["./data-chart-type-stacked100-spline-area-series.component.scss"]
})
export class DataChartTypeStacked100SplineAreaSeriesComponent {
