...
@Component({
    selector: 'app-category-chart-area-chart-with-legend',
    templateUrl: './category-chart-area-chart-with-legend.component.html',
    styleUrls: ['./category-chart-area-chart-with-legend.component.scss']
})
export class CategoryChartAreaChartWithLegendComponent implements OnInit {
