...
@Component({
  selector: "app-data-chart-type-stacked100-area-series",
  templateUrl: "./data-chart-type-stacked100-area-series.component.html",
  styleUrls: ["./data-chart-type-stacked100-area-series.component.css"]
})
export class DataChartTypeStacked100AreaSeriesComponent {
