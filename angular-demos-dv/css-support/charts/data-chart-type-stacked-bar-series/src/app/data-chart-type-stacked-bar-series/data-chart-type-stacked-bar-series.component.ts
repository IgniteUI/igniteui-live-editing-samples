...
@Component({
  selector: "app-data-chart-type-stacked-bar-series",
  templateUrl: "./data-chart-type-stacked-bar-series.component.html",
  styleUrls: ["./data-chart-type-stacked-bar-series.component.css"]
})
export class DataChartTypeStackedBarSeriesComponent {
