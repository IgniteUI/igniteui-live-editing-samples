...
@Component({
    ...
    selector: "app-category-chart-axis-options-sample",
    styleUrls: ["./category-chart-axis-options-sample.component.css"],
    templateUrl: "./category-chart-axis-options-sample.component.html"
})
export class CategoryChartAxisOptionsComponent {
