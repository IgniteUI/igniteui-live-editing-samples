...
@Component({
  selector: "app-data-chart-type-stacked-area-series",
  templateUrl: "./data-chart-type-stacked-area-series.component.html",
  styleUrls: ["./data-chart-type-stacked-area-series.component.css"]
})
export class DataChartTypeStackedAreaSeriesComponent {
