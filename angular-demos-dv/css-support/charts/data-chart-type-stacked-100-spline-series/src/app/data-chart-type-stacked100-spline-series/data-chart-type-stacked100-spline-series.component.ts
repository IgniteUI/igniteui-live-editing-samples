...
@Component({
  selector: "app-data-chart-type-stacked100-spline-series",
  templateUrl: "./data-chart-type-stacked100-spline-series.component.html",
  styleUrls: ["./data-chart-type-stacked100-spline-series.component.css"]
})
export class DataChartTypeStacked100SplineSeriesComponent {
