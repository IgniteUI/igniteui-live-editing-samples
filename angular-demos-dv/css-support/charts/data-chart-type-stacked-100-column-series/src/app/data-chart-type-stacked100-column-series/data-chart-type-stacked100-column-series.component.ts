...
@Component({
  selector: "app-data-chart-type-stacked100-column-series",
  templateUrl: "./data-chart-type-stacked100-column-series.component.html",
  styleUrls: ["./data-chart-type-stacked100-column-series.component.css"]
})
export class DataChartTypeStacked100ColumnSeriesComponent {
