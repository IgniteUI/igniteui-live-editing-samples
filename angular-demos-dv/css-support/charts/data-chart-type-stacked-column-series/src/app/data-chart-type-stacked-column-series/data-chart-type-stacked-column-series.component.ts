...
@Component({
  selector: "app-data-chart-type-stacked-column-series",
  templateUrl: "./data-chart-type-stacked-column-series.component.html",
  styleUrls: ["./data-chart-type-stacked-column-series.component.css"]
})
export class DataChartTypeStackedColumnSeriesComponent {
