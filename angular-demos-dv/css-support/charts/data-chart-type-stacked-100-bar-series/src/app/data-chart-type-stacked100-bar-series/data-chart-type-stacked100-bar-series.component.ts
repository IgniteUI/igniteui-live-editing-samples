...
@Component({
  selector: "app-data-chart-type-stacked100-bar-series",
  templateUrl: "./data-chart-type-stacked100-bar-series.component.html",
  styleUrls: ["./data-chart-type-stacked100-bar-series.component.css"]
})
export class DataChartTypeStacked100BarSeriesComponent {
