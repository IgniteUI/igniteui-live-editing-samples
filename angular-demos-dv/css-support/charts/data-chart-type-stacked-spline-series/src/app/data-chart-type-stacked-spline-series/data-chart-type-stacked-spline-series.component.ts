...
@Component({
  selector: "app-data-chart-type-stacked-spline-series",
  templateUrl: "./data-chart-type-stacked-spline-series.component.html",
  styleUrls: ["./data-chart-type-stacked-spline-series.component.css"]
})
export class DataChartTypeStackedSplineSeriesComponent {
